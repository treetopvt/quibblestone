...
public sealed class TemplateCatalog
{
    ...
    [
        ...
        new TemplateCatalogEntry("fa-squirrel-acorn-heist", FamilySafe: true, BlankCount: 10, HasWordBank: true),
        ...
        new TemplateCatalogEntry("fa-dog-thinks-cat", FamilySafe: true, BlankCount: 6, HasWordBank: true),
        new TemplateCatalogEntry("fs-alien-exchange-student", FamilySafe: true, BlankCount: 9),
        new TemplateCatalogEntry("fs-vacuum-rebellion", FamilySafe: true, BlankCount: 10, HasWordBank: true),
        ...
        new TemplateCatalogEntry("fc-school-bake-off-chaos", FamilySafe: true, BlankCount: 10, HasWordBank: true),
        ...
        new TemplateCatalogEntry("fl-lemonade-empire", FamilySafe: true, BlankCount: 6, HasWordBank: true),
        ...
        new TemplateCatalogEntry("ad-worst-first-date", FamilySafe: false, BlankCount: 10, HasWordBank: true),
        ...
        new TemplateCatalogEntry("ad-group-chat-ex", FamilySafe: false, BlankCount: 6, HasWordBank: true),
        new TemplateCatalogEntry("ao-monday-all-hands", FamilySafe: false, BlankCount: 9),
        new TemplateCatalogEntry("ao-holiday-party-chaos", FamilySafe: false, BlankCount: 10, HasWordBank: true),
        ...
        new TemplateCatalogEntry("ap-vegas-blackout", FamilySafe: false, BlankCount: 10, HasWordBank: true),
        new TemplateCatalogEntry("ap-new-years-resolution", FamilySafe: false, BlankCount: 5),
        new TemplateCatalogEntry("ap-karaoke-showdown", FamilySafe: false, BlankCount: 6, HasWordBank: true),
    ];
