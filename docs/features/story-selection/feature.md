...
|---|---|---|---|
| 01 | TBD | Length classes + the one selection pipeline | Not Started |
| 02 | TBD | Quick story option (solo + group) | Not Started |
| 03 | TBD | Freshness rotation: no repeats until the pool runs dry | Not Started |
| 04 | TBD | Story delivery metrics (the anonymous serve log) | Not Started |
| 05 | TBD | Like / dislike a tale (content feedback) | Not Started |
